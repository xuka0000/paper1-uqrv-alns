...
def _solver_mapping(method: str, size: str) -> tuple[str, int]:
    ...
    mapping = {
        ...
        "simulated_annealing": ("simulated_annealing", max(40, iterations // 2)),
        "tabu_search": ("tabu_search", max(40, iterations // 2)),
        "variable_neighborhood_search": ("variable_neighborhood_search", max(40, iterations // 2)),
        "hybrid_genetic_search": ("hybrid_genetic_search", max(40, iterations // 2)),
