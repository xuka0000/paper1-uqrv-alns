...
- Main file: `tre_manuscript_5p.tex`
- Document class: `\documentclass[final,5p,twocolumn,number,nopreprintline]{elsarticle}`
...
latexmk -xelatex -interaction=nonstopmode -halt-on-error tre_manuscript_5p.tex
```
